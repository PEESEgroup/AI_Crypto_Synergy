...
eqPbalance(t).. Ptotal(t) =e= Pai(t)+Pcharge(t)*cyceff+Pdac(t) ;
...
eqCtotal.. Ctotal =e= Csolar+Cwind+Cbattery+Cinterface+Cdac ;
...
eqSALtotal.. SALtotal =e= (SALsolar+SALwind+SALbattery+SALinterface+SALdac)/((1+d)**NY) ;
