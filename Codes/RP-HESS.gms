...
eqPbalance(t).. Ptotal(t) =e= Pai(t)+Pele(t)+Pdac(t) ;
...
eqCtotal.. Ctotal =e= Csolar+Cwind+Cele+Cfc+Chtank+Cdac ;
...
eqOPEXtotal.. OPEXtotal =e= OPEXsolar+OPEXwind+OPEXgrid+OPEXele+OPEXfc+OPEXPenalty+OPEXtank+OPEXdac+OPEXtransport+OPEXstorage ;
...
eqSALtotal.. SALtotal =e= (SALsolar+SALwind+SALele+SALfc+SALhtank+SALdac)/((1+d)**NY) ;
