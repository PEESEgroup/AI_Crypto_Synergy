...
eqPbalance(t).. Ptotal(t) =e= Pai(t)+Pbitcoin(t)+Pele(t)+Pdac(t) ;
...
eqCtotal.. Ctotal =e= Csolar+Cwind+Cminer+Chpump+Cele+Cfc+Chtank+Cdac ;
...
eqOPEXtotal.. OPEXtotal =e= OPEXsolar+OPEXwind+OPEXhpump+OPEXgrid+OPEXPenalty+OPEXtank+OPEXele+OPEXfc+OPEXdac+OPEXtransport+OPEXstorage ;
...
eqSALtotal.. SALtotal =e= (SALsolar+SALwind+SALminer+SALhpump+SALele+SALfc+SALhtank+SALdac)/((1+d)**NY) ;
